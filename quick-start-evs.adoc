...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-6.png["Sei"] Esamina le well-architected insights per il tuo ambiente EVS
[role="quick-margin-para"]
Quando il tuo ambiente EVS viene rilevato, Workload Factory esegue automaticamente scansioni giornaliere well-architected per identificare problemi di configurazione e fornire raccomandazioni per la remediation.

[role="quick-margin-para"]
link:view-evs-well-architected.html["Scopri come implementare configurazioni ben architettate"^].
