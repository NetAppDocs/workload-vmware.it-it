...
. Dal menu VMware, seleziona *Valuta e pianifica*, quindi seleziona *Migrazione a VMware Cloud su AWS*.
+
Viene visualizzata la pagina principale di VMware Migration Advisor.

. Selezionare *Pianifica e crea VMC*.
. Seleziona *Iniziamo!*. Puoi scegliere di non visualizzare più questa pagina selezionando la casella di controllo.
...
.Fasi
. Scarica e installa RVTools 4.4.2 o versione successiva in https://www.dell.com/en-us/shop/vmware/sl/rvtools["Sito Web RVTools"^]
...
+
Vedere il capitolo sui "parametri della riga di comando" nel https://www.dell.com/en-us/shop/vmware/sl/rvtools["Documentazione di RVTools nella sezione Risorse"^] per i dettagli.
