...
Quando si esegue la migrazione a VMware Cloud, è possibile utilizzare il consulente per la migrazione per migrare l'attuale ambiente vSphere on-premise a VMWare Cloud.
