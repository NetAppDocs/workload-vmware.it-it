...
---
= Assistenza nella farm di workload BlueXP  per VMware
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
.Prima di iniziare
Per utilizzare la funzionalità *Crea un caso*, è necessario prima registrarsi per ricevere assistenza. Associare le credenziali del sito di supporto NetApp all'accesso alla fabbrica del carico di lavoro. link:support-registration.html["Scopri come registrarti per il supporto"].
